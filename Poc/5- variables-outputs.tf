...
output "web_linuxvm_private_ip_address_list" {
  ...
  # 1 Way 
  value = [for vm in azurerm_windows_virtual_machine.web_linuxvm: vm.private_ip_address]
}
...
output "web_linuxvm_private_ip_address_map" {
  description = "Web Linux Virtual Machine Private IP"
  # 2 Way
  value = {for vm in azurerm_windows_virtual_machine.web_linuxvm: vm.name => vm.private_ip_address}
}
...
output "web_linuxvm_private_ip_address_keys_function" {
  description = "Web Linux Virtual Machine Private IP"
  value = keys({for vm in azurerm_windows_virtual_machine.web_linuxvm: vm.name => vm.private_ip_address})
}
...
output "web_linuxvm_private_ip_address_values_function" {
  description = "Web Linux Virtual Machine Private IP"
  value = values({for vm in azurerm_windows_virtual_machine.web_linuxvm: vm.name => vm.private_ip_address})
}
...
output "web_Admin_vm" {
  ...
  value = [for vm in azurerm_windows_virtual_machine.web_linuxvm: vm.admin_username]
}
...
output "web_Password_vm" {
  ...
  sensitive   = true
  value = [for vm in azurerm_windows_virtual_machine.web_linuxvm: vm.admin_password]
}
